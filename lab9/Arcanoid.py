...
settings = pygame.transform.scale(settings, (70, 70))
...
# Time variables
time_elapsed = 0
speed_increase_interval = 1000  # Увеличение скорости каждые 1 секунду (в миллисекундах)
speed_increase_amount = 0.2  # Сумма, на которую увеличивается скорость
shrink_paddle_interval = 5000  # Сжимать весло каждые 5 секунд (в миллисекундах)
...
def handle_settings_click():
    ...
    if click[0]:
        ...
        if W - 70 <= x <= W and 0 <= y <= 70:
            # Handle settings menu
            print("Settings menu clicked")  # Placeholder for settings menu implementation
